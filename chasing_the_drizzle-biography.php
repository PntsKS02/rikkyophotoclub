...
<meta property="og:image" content="https://rikkyophotoclub.com/img/DMtop.jpg" /> 
    <title>BIOGRAPHY | にわか雨を追いかけて</title>
...
<script>
    ...
    <div id="title_area">
        ...
        <div id="main_area">
            <div id="main_title">BIOGRAPHY</div>
            <div id="main_sentence">
                <div id = "prof_box">
                    <div id = "name">RYU<br>HATAKEYAMA</div>
                    <div id = "prof_right">
                        <div id ="prof_sentence">2000年、宮城県に生まれる。<br>2019年、立教大学社会学部現代文化学科入学。現在は映像作家坪井隆寛氏を師事。<br>愛機はOlympus PEN-F、Canon demi EE17、Kyocera Samurai。</div>
                    </div>
                </div>
                <div id = "prof_box">
                    <div id = "name">WATARU<br>NIHEI</div>
                    <div id = "prof_right">
                        <div id ="prof_sentence">2002年、福島県に生まれる。<br>2020年、立教大学文学部文学科フランス文学専修入学。<br>愛機はX100F、Olympus µ2。</div>
                    </div>
                </div>
                <div id = "prof_box">
                    <div id = "name">KIICHI<br>SAITO</div>
                    <div id = "prof_right">
                        <div id ="prof_sentence">2002年、山形県に生まれる。<br>2021年立教大学現代心理学部映像身体学科入学。2022年、自身の二十歳の誕生日に『柳瀬川2』を発表。<br>愛機はKyocera CONTAX T2、RICOH GR10。</div>
                    </div>
                </div>
            </div>
        </div>
