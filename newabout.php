       ...
       <div id="loading_screen">
        ...
        <div id="title_area">
               <div id="t_t">
                ...
                <ul class="menubar_PC">
                    <a href = "" class = "bar_a"><li>TOP</li></a>
                    <a href = "history" class = "bar_a"><li>HISTORY</li></a>
                    <a href = "about" class = "bar_a"><li>ABOUT US</li></a>
                    <a href = "activities" class = "bar_a"><li>ACTIVITIES</li></a>
                    <a href = "exhibition" class = "bar_a"><li>EXHIBITION</li></a>
                    <a href = "link" class = "bar_a"><li>SNS/LINK</li></a>
                </ul>
        </div>
        <div id="main_area">
           <div id="main_box">
            <div id="main_title">ABOUT US</div>
            <div id="new_history">
                <div id="history_sentence">私たち立教大学写真部は、現在部員約50名で活動している公認団体です。
<br>
主な活動としては、毎週土曜13時から部会を行い、連絡事項の共有をするほか、写真展に出展する作品を持ち寄って部員同士で意見を出し合う「セレクト」を行なっています。
<div id="pictureS">
        <img class="topixpic" src="../img/S__112885762.jpg">
    <div id = "pictureS2">▲部会の様子</div>
    </div>
写真展は、新入生による新人展や、学園祭での大規模な展示、他大学との交流を図る六大学写真展など 様々な機会があり、部員それぞれが展示に向けた作品作りに努めています。
    <div id="pictureS">
        <img class="topixpic" src="../img/S1.jpg">
        <div id = "pictureS2">▲SPF展の設営</div>
    </div>
週一回の部会以外では、部室でお昼ご飯をみんなで食べたり、撮影に出かけたりと自由に過ごしています。
<div id="pictureS">
       <img class="topixpic" src="../img/SF2.jpg">
    <div id = "pictureS2">▲部室でわいわい</div>
        <img class="topixpic" src="../img/S__112885764.jpg">
    <div id = "pictureS2">▲合宿などのレクリエーションも充実！</div>
    </div>
また、部室内には暗室も完備しており、モノクロフィルムの現像に加え、写真を焼くことも可能です。
<br>
写真部に興味のある方は、池袋キャンパス・ウィリアムズホール1階の105部室に是非お越しください！部員一同温かく歓迎致します！</div>
                </div>
            </div>
