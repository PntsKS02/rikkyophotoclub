...
<meta property="og:title" content="DIGITAL TOUR | ROOM105" /> 
...
<meta property="og:image" content="https://rikkyophotoclub.com/img/卒展 DM横2.jpg" /> 
        <title>DIGITAL TOUR | ROOM105</title>
       ...
       <img class="top_pic_Mobile" src="../img/back_pic-02.jpg">
         ...
         <img class="menu_icon_close" src="../img/icon-1.png" onclick = "closes()"> 
           ...
           <div id="menu_list">
            ...
            <div class="area_1" >
                <div id="area_title">DIGITAL TOUR</div>
            <div id="area_sub">ROOM105 デジタルツアー</div>
            <div id="area_main">
            <div id="page_tour"><a href = "room105">ROOM105 TOP</a>　>　<a href = "room105-summary">SUMMARY</a>　>　DIGITAL TOUR</div>
            <div id="area_sentence">
                ROOM105　デジタルツアーへようこそ。<br>当ページでは、展示を360度カメラで記録したものを閲覧できます。<br>
            </div>
                <div class="area_title2"  id = "opentime">First Floor</div>
                <blockquote data-width="100%" data-height="500" class="ricoh-theta-spherical-image" >Post from RICOH THETA. - <a href="https://theta360.com/s/b1ipYZRh3vfiFlTFbRyJgyB1s" target="_blank">Spherical Image - RICOH THETA</a></blockquote>
                <script async src="https://theta360.com/widgets.js" charset="utf-8"></script>
                 <div class="area_title2"  id = "opentime">Semi-Basement Floor</div>
                <blockquote data-width="100%" data-height="500" class="ricoh-theta-spherical-image" >Post from RICOH THETA. - <a href="https://theta360.com/s/fBpLbxSTYFDcwXFuvbb4Pbr8K" target="_blank">Spherical Image - RICOH THETA</a></blockquote>
<script async src="https://theta360.com/widgets.js" charset="utf-8"></script>
                </div>
        </div> 
