    ...
    <body>
        ...
        <div id="main_area">
           <div id="main_box">
            ...
            <div id="new_info">
               <div id="info_left">
                <div id="info_date">2021-10-25</div>
                <div id="info_title">SPF展2021　開催のお知らせ</div>
                </div>
                <div id="info_sentence">詳しく見る >>></div>
            </div><div id="new_info">
               <div id="info_left">
                <div id="info_date">2021-10-28</div>
                <div id="info_title">写真部公式サイト　リニューアル</div>
                </div>
                <div id="info_sentence">詳しく見る >>></div>
            </div><div id="new_info">
               <div id="info_left">
                <div id="info_date">2021-10-31</div>
                <div id="info_title">SPF展特別サイト　オープン</div>
                </div>
                <div id="info_sentence">詳しく見る >>></div>
            </div>
            </div>
        ...
        <div id="main_title">Contents</div>
            ...
            <div id="info_area">
                ...
                <a href = "activies#exhibit"><div id="info_title">SPF展・新人展</div></a>
                <a href = "activies#other"><div id="info_title">その他イベントについて</div></a>
