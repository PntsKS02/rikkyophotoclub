       ...
       <img class="top_pic_Mobile" src="../img/back_pic-02.jpg">
         ...
         <img class="menu_icon_close" src="../img/icon-1.png" onclick = "closes()"> 
           ...
           <div id="menu_list">
            ...
            <div class="area_1" style="overflow-x:visible">
                <div id="area_title">GALLERY</div>
            <div id="area_sub">デジタルギャラリー</div>
            <div id="area_main" >
            <div id="page_tour"><a href = "room105">ROOM105 TOP</a>　>　<a href = "room105-gallery">GALLERY</a>　>　<?= $room105["first_roma"] ?>  <?= $room105["middle_roma"] ?></div>
            ...
            <div id="insta_area2">
              <?php
               ...
               $AP = 0;
                   ...
                   <?php
	           foreach($photo_datas["data"] as $datamath){
                   /*
		...
		?>
              <div id="gallery_img_wrap" class="<?= $room105["instagram"]?>">
               <img class="gallery_imgs" id = "<?= $AP ?>" src="<?= $photo_datas["data"][$AP]["media_url"] ?>">
                </div>
       <?php
      $AP = $AP + 1;
               }
		...
		?>
              <a href = "room105-gallerydetail?Num=<?= $room105a["id"]?>">
