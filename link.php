...
<meta property="og:title" content="ACTIVITIES | Rikkyo Photo Club" /> 
<meta property="og:description" content="立教大学写真部の公式ページです。" /> 
<meta property="og:image" content="../img/キービジュ.png" /> 
    <title>ACTIVITIES | Rikkyo Photo Club</title>
  ...
  gtag('config', 'UA-139853085-2');
    ...
    <body>
       <div id="loading_screen">
        ...
        <div id="main_area">
           <div id="main_box">
            <div id="main_title">SNS/LINK</div>
            <div class="main_subtitle" id="sns">SNS</div>
              <!--<a href="spf2021"> -->
            ...
            <div id="info_SNS">
                ...
                写真部公式Twitterでは、写真展をはじめとした展示、部活での行事、写真部の紹介などを行っています。<br>
                フォローすることで、写真部が主催する展示の情報をいち早くキャッチできます。<br>
                みなさまのフォローをお待ちしています。
                </div>
                </div><div id="info_SNS" style = "margin-top:30px;">
                <div id="info_title"><img class="sns_pic" src="../img/instagram.png"><div id="info_titleA">Instagram : @rikkyo_photo</div></div>
                <div id="history_sentence">
                写真部公式Instagramでは、写真展の告知だけでなく、部員の作品紹介や小企画なども行います。<br>
                ぜひフォローをお願いします！
                </div>
            </div>
            </div> 
            <div class="main_subtitle" id="link">LINK</div>
        </div>
        </div>
        <div id="footer">
