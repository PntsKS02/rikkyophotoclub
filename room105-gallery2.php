   ...
   <html lang = "ja"> <!--言語設定です--> 
    <head> 
       ...
       <link rel="stylesheet" type="text/css" href="../css/room105.css" media="(min-width: 1100px)">         
        ...
        <meta property="og:title" content="room105-exhibitior | Rikkyo Photo Club" /> 
        ...
        <title>room105-sns | Rikkyo Photo Club</title>
       ...
       <img class="top_pic_Mobile" src="../img/back_pic-02.jpg">
         ...
         <img class="menu_icon_close" src="../img/icon-1.png" onclick = "closes()"> 
           ...
           <div id="menu_list">
            ...
            <div id="gallery_subtitle">Rikkyo Photo Club<br>Graduate Exhibition 2022</div>
            <div class="area_1" >
