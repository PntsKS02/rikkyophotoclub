  ...
  gtag('config', 'UA-139853085-2');
    ...
    <body>
       <div id="loading_screen">
        ...
        <div id="main_area">
           <div id="main_box">
            <div id="main_title">404 NOT FOUND</div>
            <div id="new_history">
                <div id="history_sentence">立教大学写真部のページにお越しくださいまして、ありがとうございます。<br>恐れ入りますが、お探しのページは見つかりませんでした。<br>移動、削除された可能性があります。<br>また、URL名などに間違いが無いかもう一度ご確認ください。<br><br>メニュー欄より、他のページへアクセスできます。</div>
                </div>
            </div>
