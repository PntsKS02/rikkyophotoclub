...
<meta property="og:title" content="EXHIBITIOR | ROOM105" /> 
...
<meta property="og:image" content="https://rikkyophotoclub.com/img/卒展 DM横2.jpg" /> 
        <title>EXHIBITIOR | ROOM105</title>
                 ...
                 $("#loading_screen").css({"display":"block"});
                    ...
                    $("#loading_screen").delay(300).velocity({
                        ...
                        duration:"300"
                          ...
                          setTimeout(function(){
                            window.location.assign("https://rikkyophotoclub.com/room105-exhibitior-detail?Num=" + ids);  // 0.8秒後に取得したURLに遷移
                          }, 700);
                        }
       ...
       <img class="top_pic_Mobile" src="../img/back_pic-02.jpg">
         ...
         <img class="menu_icon_close" src="../img/icon-1.png" onclick = "closes()"> 
           ...
           <div id="menu_list">
            ...
            <div id="area_main">
            <div id="page_tour"><a href = "room105">ROOM105 TOP</a>　>　EXHIBITIOR</div>
            <div id="area_sentence">
            ROOM 105は以下の7名の展示です。<br>
            参加者の名前をクリックすると、詳細なプロフィールを見ることができます。
                </div>
            <?php
		...
		?>
            <div class="exhibitior_area" style="border-left-color:<?= $room105["colors"] ?>;" onclick = "exdetail('<?= $room105["id"]?>')">  
               <div id="status_left">
                ...
                <div id="exhibitior_faculty"><?= $room105["faculty"]?></div>
                   <div id="exhibitior_theme"><?= $room105["theme"]?></div>
                </div>
                <div id="status_right">
                <div id="exhibitior_camera"><br>
                <?php 
