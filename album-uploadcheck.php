...
$trimimage = imagecreatetruecolor($diffW/$zip,$diffH/$zip); 
  ...
  $squarefile ='img/trim'.$pictures;
   ...
   $sql = "insert into album1(file,squarefile,type)values(?,?,?)";
...
<html lang = "ja"> <!--言語設定です--> 
    <head>
       ...
       <link rel="stylesheet" type="text/css" href="../css/NewTop.css" media="(min-width: 1100px)">         <link href="../css/NewTopM.css" rel="stylesheet" type="text/css" media="(min-width: 160px) and (max-width: 599px)" >         <link href="../css/NewTopT.css" rel="stylesheet" type="text/css" media="(min-width: 600px) and (max-width: 1099px)" >
  ...
  (function(d) {
   ...
   <body>
        ...
        <div id="main_area">
           <div id="main_box">
            <div id="main_title">ALBUM SC</div>
        </div>
       </div>
    </body>
</html>