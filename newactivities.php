  ...
  gtag('config', 'UA-139853085-2');
    ...
    <body>
           ...
           <div id="main_box">
            <div id="main_title">ACTIVITIES</div>
              <div id="notice">
                  ...
                  <div id="notice_sentence">これらのイベントは新型コロナウイルス感染拡大前の2019年に行われたものです。<br>2022年の写真部におけるイベントの実施については、感染の状況によって中止になることもあります。</div>
              </div>
       ...
       <div id="info_sentence">
           ...
           【部会の主な内容】<br>
1． 連絡事項<br>
写真部の活動および行事予定はここで話されます。<br>
主に、SPF・新人展等写真の締め切り、写真部によるイベントの告知などが行われます。<br><br>
...
セレクトは、写真を出し合って皆で意見を交換する場としています。<br>
       ...
       <div id="info_sentence">
           ...
           2021年は、5号館の廊下で展示を行います。　オンラインでの並行開催に関してはまだ未定です。<br>
           
       </div>
        </div>
               <div id="info_area">
		<div id="title3">六大学写真展</div>
       <img class="info_pic" src="../img/R1.jpg">
       <div id="info_sentence">
        例年、3月の頭に行っています。<br>
